...
**| `./data/scaled_simulation_covariates.csv` |** The spatial covariate data for each site across the Chicagoland study area used to forecast striped skunk occupancy predictions through space and time. This file is generated by the `./R/skunk_simulation_covariate_prep.R` located in in the R folder (`./R`) - [Group 6 - Simulations](#group-6---simulations). This csv file contains 4067 rows and 7 columns.

| Column     | Data Type | Explanation                                                                                                                                                                     |
| ---------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Site       | `factor`  | Simulated site designations                                                                                                                                                     |
...
**| `./data/phi_gamma_delta_by_season.RDS` |** The output of a model to simulate occupancy and its parameters across Chicagoland area and through time created by [`./R/simulation_model.R`](#group-6---simulations) in the R folder (`./R`) - [Group 6 - Simulations](#group-6---simulations).
