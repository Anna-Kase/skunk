...
**| `./data/scaled_simulation_covariates.csv` |** The spatial covariate data for each site across the Chicagoland study area used to forecast striped skunk occupancy predictions through space and time. This file is generated by the `./R/skunk_simulation_covariate_prep.R` located in [the R folder (`./R`)](#the-r-folder-R). This csv file contains 4067 rows and 7 columns.
